      ...
      <div className="contact-action">
        ...
        <div class="modal-overlay" id="open-window-content">
          <div class="open-window">
            <h2>Сontact us</h2><a class="close" href="#">×</a>
            <div class="modal-content-body">
              <div className="network-icons">
                <a href='https://www.instagram.com/donch1kk/' target='_blank' rel="noopener"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="network-icon" viewBox="0 0 16 16">
                ...
                <a href='https://twitter.com/DaniyarKemelbe1' target='_blank' rel="noopener">
                ...
                <a href='https://www.linkedin.com/in/daniyar-kemelbekov-107a4b25a/' target='_blank' rel="noopener">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="network-icon" viewBox="0 0 16 16">
