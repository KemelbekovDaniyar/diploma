  ...
  return (
    <div className="contacts-container container">
      ...
      <div className="contact-action">
        <a className="btn-modal" href="#open-window-content">Contact</a>
        <div className="modal-overlay" id="open-window-content">
          <div className="open-window">
            <h2>Сontact us</h2><NavLink className="close" href="#">×</NavLink>
            <div className="modal-content-body">
              <div className="network-icons">
                ...
                <a href='https://twitter.com/DaniyarKemelbe1' target='_blank' rel="noreferrer">
                ...
                <a href='https://www.linkedin.com/in/daniyar-kemelbekov-107a4b25a/' target='_blank' rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="network-icon" viewBox="0 0 16 16">
